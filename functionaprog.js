...
// Functional Programming: Implement map on a PrototypePassed
...
var filteredList = watchList.filter(movie => movie.imdbRating >= 8)
.map(movie => {
...
// Functional Programming: Combine Two Arrays Using the concat MethodPassed
...
function getRating(watchList){
  ...
  averageRating = watchList
    //narrows down list to only Nolal films
    .filter(film => film.Director === "Christopher Nolan")
    //convert ratings, which are strings, to numbers
